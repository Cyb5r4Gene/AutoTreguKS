...
public class PostAdapteri extends RecyclerView.Adapter<PostAdapteri.ViewHolder> {

    private List<ListItem> listItems;
    Context context;
    private PostAdapteri.OnItemListener onItemListener;

    public PostAdapteri(List<ListItem> listItems, Context context, OnItemListener onItemListener) {
