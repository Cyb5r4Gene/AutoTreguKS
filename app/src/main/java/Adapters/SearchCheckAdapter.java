...
//        } else if (id == 2) {
//            if (position == 1)
//                holder.check.setChecked(SearchFragment.searchConditions.getLicencePlates().isKosovo());
//            else if (position == 2)
//                holder.check.setChecked(SearchFragment.searchConditions.getLicencePlates().isAlbania());
//            else if (position == 3)
...
//                    else if (position == 1)
//                        SearchFragment.searchConditions.getLicencePlates().setKosovo(isChecked);
//                    else if (position == 2)
//                        SearchFragment.searchConditions.getLicencePlates().setAlbania(isChecked);
//                    else if (position == 3)
