...
public class User {
    ...
    public String adresaID;

    public User() { }

    public User(String emri, String mbiemri, String email, String datelindja,  String tel, String tipi, String dataKrijimit, String editimiFundit, String adresaID)
    {
        this.emri = emri;
