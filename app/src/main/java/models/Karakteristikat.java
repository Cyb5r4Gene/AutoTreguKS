...
public class Karakteristikat {
    ...
    private String kondicioneri;
    private Airbag airbag;

    public Karakteristikat(){}

    public Karakteristikat(boolean bluetooth, boolean onBoardKompjuter, boolean CDPlayer, boolean xhamaElektrik, boolean uleseMeLevizjeElektrike, boolean uleseMeNxemje, boolean uleseSportive, boolean mp3, boolean aux, boolean pullaNeTimon, boolean navigacion, boolean shiber, boolean panorame, boolean bagazhNeCati, boolean mbylljeQendrore, boolean pasqyreElektrike, boolean amortizimSportiv, boolean sportPakete, boolean abs, boolean katerX4, boolean esp, boolean dritaAdaptuese, boolean sensorDritash, boolean dritaTeMjegulles, boolean dritaXenon, boolean dritaBiXenon, boolean sensorShiu, boolean startStop, String kondicioneri, Airbag airbag) {
    ...
    public String getKondicioneri() {
        return kondicioneri;
    }

    public void setKondicioneri(String kondicioneri) {
        this.kondicioneri = kondicioneri;
    }
