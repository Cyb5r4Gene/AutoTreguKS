...
public class AdvancedSearchFragment extends Fragment implements DialogCheckAdapter.OnCheckListener, DialogPostAdapter.OnDialogListener, SearchCheckAdapter.OnCheckListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        checkMetallic.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                SearchFragment.searchConditions.setMetalike(isChecked);
            }
        });
    ...
    private void checkDialog(int i){
        ...
        if(btnID==1){
            tvTitle.setText("Karroceria");
            dialogItems = Arrays.asList(getResources().getStringArray(R.array.karroceria));
            ...
            checked[2] = SearchFragment.searchConditions.getVehicle().isCabriolet();
            ...
            checked[12] = SearchFragment.searchConditions.getInteriorSearch().isPanoramic();
            checked[13] = SearchFragment.searchConditions.getInteriorSearch().isRoofRack();
            checked[14] = SearchFragment.searchConditions.getInteriorSearch().isCentralCloser();
        } else if(btnID==8){
            tvTitle.setText("Siguria dhe ambienti");
            ...
            checked = new boolean[dialogItems.size()];
            checked[0] = SearchFragment.searchConditions.getAirbag().isAirbagShoferi();
            checked[1] = SearchFragment.searchConditions.getAirbag().isAirbagAnesor();
            checked[2] = SearchFragment.searchConditions.getAirbag().isAirbagIPrapme();
            checked[3] = SearchFragment.searchConditions.getAirbag().isAirbagTjere();
            checkDialog.getWindow().setLayout(width-100, width-100);
        } else if(btnID==10){
            tvTitle.setText("Parkimi");
    ...
    private void initValues(){
        if(SearchFragment.searchConditions.getSeatsNr()!=0){
            List<String> items = Arrays.asList(getResources().getStringArray(R.array.ulse));
        ...
        if(SearchFragment.searchConditions.getClimatissation()!=0){
            List<String> items = Arrays.asList(getResources().getStringArray(R.array.kondicioneri));
        ...
        if(SearchFragment.searchConditions.getDamaged()==0){
            tvDamaged.setText("Shfaqi");
        }

        if(SearchFragment.searchConditions.getDamaged()==1){
            tvDamaged.setText("Mos i shfaq");
        }
        ...
        if(SearchFragment.searchConditions.getVehicle().isCaravan())
            text+=" - "+items.get(1);
        if(SearchFragment.searchConditions.getVehicle().isCabriolet())
            text+=" - "+items.get(2);
        ...
        items = Arrays.asList(getResources().getStringArray(R.array.transmisioni));
        text = "";
        ...
        if(SearchFragment.searchConditions.getInteriorSearch().isNav())
            text+=" - "+items.get(10);
        if(SearchFragment.searchConditions.getInteriorSearch().isShiber())
            text+=" - "+items.get(11);
        ...
        text = " ";
        if(SearchFragment.searchConditions.getAirbag().isAirbagShoferi())
            text+=items.get(0);
        if(SearchFragment.searchConditions.getAirbag().isAirbagAnesor())
            text+=" - "+items.get(1);
        if(SearchFragment.searchConditions.getAirbag().isAirbagIPrapme())
            text+=" - "+items.get(2);
        if(SearchFragment.searchConditions.getAirbag().isAirbagTjere())
            text+=" - "+items.get(3);
    ...
    public void onSearchCheck(int position) {
        if(btnID==1){
            if(position==0){
                ...
                SearchFragment.searchConditions.getVehicle().setCabriolet(!SearchFragment.searchConditions.getVehicle().isCabriolet());
            }else if(position==3){
            ...
            if(position==0){
                ...
                SearchFragment.searchConditions.getInteriorSearch().setShiber(!SearchFragment.searchConditions.getInteriorSearch().isShiber());
            }else if(position==12){
            ...
            if(position==0){
                SearchFragment.searchConditions.getAirbag().setAirbagShoferi(!SearchFragment.searchConditions.getAirbag().isAirbagShoferi());
            }else if(position==1){
                SearchFragment.searchConditions.getAirbag().setAirbagAnesor(!SearchFragment.searchConditions.getAirbag().isAirbagAnesor());
            }else if(position==2){
                SearchFragment.searchConditions.getAirbag().setAirbagIPrapme(!SearchFragment.searchConditions.getAirbag().isAirbagIPrapme());
            }else if(position==3){
                SearchFragment.searchConditions.getAirbag().setAirbagTjere(!SearchFragment.searchConditions.getAirbag().isAirbagTjere());
            }
